...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    practice_instructions_1 = visual.TextStim(win=win, name='practice_instructions_1',
        text='Esto es un experimento de DECISIÓN LÉXICA\n\nEn la pantalla irán apareciendo palabras y no palabras. Debe decidir si es una palabra real o inventada\n\nHagalo lo más rápido que pueda,\nintentando no cometer errores\n\nPresiona ESPACIO para continuar.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text = visual.TextStim(win=win, name='text',
        text='Cuando sea una PALABRA REAL, pulse la flecha IZQUIERDA.\n\nCuando sea una PALABRA INVENTADA, pulse la flecha DERECHA.\n\nPulse ESPACIO para continuar.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Cuando estes listo para continuar presione ESPACIO.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisTrial in trials:
        ...
        _key_resp_4_allKeys = []
        # keep track of which components have finished
        pauseComponents = [text_2, key_resp_4]
